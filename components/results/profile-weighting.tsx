 ...
 *
 * The section starts closed. The client reads the summary without these charts and
 * wants them as detail further down (protocol item 16); the button in the heading
 * opens them.
 */
export function ProfileWeighting({ results }: { results: SurveyResults }) {
  ...
  return (
    <ResultsSection
      id="gewichtung-titel"
      title={t.results.weighting.title}
      description={t.results.weighting.description}
      defaultOpen={false}
    >
